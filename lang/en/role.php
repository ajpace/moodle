...
$string['archetypecoursecreator'] = 'ARCHETYPE: Competition creator';
...
$string['assignroles_help'] = 'By assigning a role to a user in a context, you are granting them the permissions contained in that role, for the current context and all lower contexts. For example, if a user is assigned the role of student in a competition, they will also have the role of student for all activities and blocks within the competition.';
...
$string['backup:backupcourse'] = 'Backup competitions';
...
$string['blog:associatecourse'] = 'Associate blog entries with competitions';
...
$string['community:add'] = 'Use the community block to search hubs and find competitions';
$string['community:download'] = 'Download a competition from the community block';
...
$string['course:create'] = 'Create competitions';
$string['course:delete'] = 'Delete competitions';
$string['course:changecategory'] = 'Change competition category';
$string['course:changefullname'] = 'Change competition full name';
$string['course:changeidnumber'] = 'Change competition ID number';
$string['course:changeshortname'] = 'Change competition short name';
$string['course:changesummary'] = 'Change competition summary';
$string['course:enrolconfig'] = 'Configure enrol instances in competitions';
$string['course:enrolreview'] = 'Review competition enrolments';
...
$string['course:markcomplete'] = 'Mark users as complete in competition completion';
$string['course:publish'] = 'Publish a competition into hub';
$string['course:request'] = 'Request new competitions';
$string['course:reset'] = 'Reset competition';
$string['course:sectionvisibility'] = 'Control section visibility';
$string['course:setcurrentsection'] = 'Set current section';
$string['course:update'] = 'Update competition settings';
$string['course:useremail'] = 'Enable/disable email address';
$string['course:view'] = 'View competitions without participation';
$string['course:viewcoursegrades'] = 'View competition grades';
$string['course:viewhiddenactivities'] = 'View hidden activities';
$string['course:viewhiddencourses'] = 'View hidden competitions';
...
$string['course:visibility'] = 'Hide/show competitions';
...
$string['deletecourseoverrides'] = 'Delete all overrides in competition';
...
$string['frontpageuserdescription'] = 'All logged in users in the frontpage competition.';
$string['globalrole'] = 'System role';
$string['globalroleswarning'] = 'WARNING! Any roles you assign from this page will apply to the assigned users throughout the entire system, including the front page and all the competitions.';
...
$string['legacy:coursecreator'] = 'LEGACY ROLE: Competition creator';
...
$string['managerdescription'] = 'Managers can access competition and modify them, they usually do not participate in competitions.';
...
$string['restore:restorecourse'] = 'Restore competitions';
...
$string['restore:viewautomatedfilearea'] = 'Restore competitions from automated backups';
$string['risks'] = 'Risks';
...
$string['site:approvecourse'] = 'Approve competition creation';
$string['site:backup'] = 'Backup competitions';
...
$string['site:import'] = 'Import other competitions into a competition';
...
$string['site:restore'] = 'Restore competitions';
