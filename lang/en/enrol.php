...
$string['actenrolshhdr'] = 'Available competition enrolment plugins';
...
$string['assignnotpermitted'] = 'You do not have permission or can not assign roles in this competition.';
...
$string['defaultenrol'] = 'Add instance to new competitions';
$string['defaultenrol_desc'] = 'It is possible to add this plugin to all new competitions by default.';
...
$string['enrolme'] = 'Enrol me in this competition';
$string['enrolmentinstances'] = 'Enrolment methods';
$string['enrolmentnew'] = 'New enrolment in {$a}';
$string['enrolmentnewuser'] = '{$a->user} has enrolled in competition "{$a->course}"';
$string['enrolments'] = 'Enrolments';
$string['enrolmentoptions'] = 'Enrolment options';
$string['enrolnotpermitted'] = 'You do not have permission or are not allowed to enrol someone in this competition';
...
$string['errorenrolcohort'] = 'Error creating cohort sync enrolment instance in this competition.';
$string['errorenrolcohortusers'] = 'Error enrolling cohort members in this competition.';
...
$string['noguestaccess'] = 'Guests can not access this competition, please try to log in.';
$string['none'] = 'None';
$string['notenrollable'] = 'You can not enrol yourself in this competition.';
$string['notenrolledusers'] = 'Other users';
$string['otheruserdesc'] = 'The following users are not enrolled in this competition but do have roles, inherited or assigned within it.';
...
$string['rolefromthiscourse'] = '{$a->role} (Assigned in this competition)';
$string['rolefrommetacourse'] = '{$a->role} (Inherited from parent competition)';
$string['rolefromcategory'] = '{$a->role} (Inherited from competition category)';
...
$string['unassignnotpermitted'] = 'You do not have permission to unassign roles in this competition';
$string['unenrol'] = 'Unenrol';
$string['unenrolconfirm'] = 'Do you really want to unenrol user "{$a->user}" from competition "{$a->course}"?';
$string['unenrolme'] = 'Unenrol me from {$a}';
$string['unenrolnotpermitted'] = 'You do not have permission or can not unenrol this user from this competition.';
...
$string['extremovedaction_help'] = 'Select action to carry out when user enrolment disappears from external enrolment source. Please note that some user data and settings are purged from competition during competition unenrolment.';
$string['extremovedsuspend'] = 'Disable competition enrolment';
$string['extremovedsuspendnoroles'] = 'Disable competition enrolment and remove roles';
$string['extremovedkeep'] = 'Keep user enrolled';
$string['extremovedunenrol'] = 'Unenrol user from competition';
