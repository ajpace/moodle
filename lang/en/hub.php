...
$string['advertise'] = 'Advertise this competition for people to join';
$string['advertised'] = 'Advertised';
$string['advertiseon'] = 'Advertise this competition on {$a}';
$string['readvertiseon'] = 'Update advertising information on {$a}';
$string['advertiseonhub'] = 'Advertise this competition on a hub';
$string['advertiseonmoodleorg'] = 'Advertise this competition on moodle.org';
$string['advertisepublication_help'] = 'Advertising your competition on a community hub server allows people to find this competition and come here to enrol.';
$string['all'] = 'All';
$string['allowglobalsearch'] = 'Publish this hub and allow global search of all competitions';
$string['allowpublicsearch'] = 'Publish this hub so people can join it';
$string['audience'] = 'Audience';
$string['audience_help'] = 'Select the intended audience for the competition.';
...
$string['communityremoved'] = 'That competition link has been removed from your list';
...
$string['contributornames_help'] = 'You can use this field to list the names of anyone else who contributed to this competition.';
$string['coursemap'] = 'Competition map';
$string['coursename'] = 'Name';
$string['courseprivate'] = 'Private';
$string['coursepublic'] = 'Public';
$string['coursepublished'] = 'This competition has been published successfully on \'{$a}\'.';
$string['courseshortname'] = 'Shortname';
$string['courseshortname_help'] = 'Enter a short name for your competition. It does not need to be unique.';
$string['coursesnumber'] = 'Number of competitions ({$a})';
$string['courseunpublished'] = 'The competition {$a->courseshortname} is no longer published on {$a->hubname}.';
$string['courseurl'] = 'Competition URL';
$string['courseurl_help'] = 'It is the URL of your competition. This URL is displayed as a link in a search result.';
$string['creatorname'] = 'Creator';
$string['creatorname_help'] = 'The creator is the competition creator.';
$string['creatornotes'] = 'Creator notes';
$string['creatornotes_help'] = 'Creator notes are a guide for teachers on how to use the competition.';
...
$string['demourl_help'] = 'Enter the demo URL of your competition. By default it is the URL of your competition. The demo URL is displayed as a link in a search result.';
$string['description'] = 'Description';
$string['description_help'] = 'This description text will be showing in the competition listing on the hub.';
$string['detectednotexistingpublication'] = '{$a->hubname} is listing a competition that does not exist any more. Alert this hub administrator that the publication number {$a->id} should be removed.';
$string['downloadable'] = 'Downloadable';
$string['educationallevel'] = 'Educational level';
$string['educationallevel_help'] = 'Select the most appropriate educational level that the competition fits into.';
...
$string['errorcourseinfo'] = 'An error occurred when retrieving competition metadata from the hub ({$a}). Please try again to retrieve the competition metadata from the hub by reloading this page later. Otherwise you can decide to continue the registration process with the following default metadata. ';
$string['errorcoursepublish'] = 'An error occurred during the competition publication ({$a}). Please try again later.';
...
$string['errorunpublishcourses']= 'Due to an unexpected error, the competitions could not be deleted on the hub. Try again later (recommended) or contact the hub administrator.';
$string['existingscreenshotnumber'] = '{$a} existing screenshots. You will be able to see these screenshots on this page, only once the hub administrator enables your competition.';
...
$string['geolocation_help'] = 'In future we may provide location-based searching. If you want to specify the location for your competition use a latitude/longitude value here (eg: -31.947884,115.871285).  One way to find this is to use Google Maps.';
$string['hub'] = 'Hub';
...
$string['language_help'] = 'The main language of this competition.';
$string['lasttimechecked'] = 'Last time checked';
$string['licence'] = 'Licence';
$string['licence_help'] = 'Select the licence you want to distribute your competition under.';
$string['licence_link'] = 'licenses';
$string['logourl'] = 'Logo URL';
$string['modulenumberaverage'] = 'Average number of competition modules ({$a})';
$string['moodleorg'] = 'Moodle.org';
$string['mustselectsubject'] = 'You must select a subject';
$string['name'] = 'Name';
$string['name_help'] = 'This name will be showing in the competition listing.';
...
$string['none'] = 'None';
$string['nosearch'] = 'Don\'t publish hub or competitions';
$string['notregisteredonhub'] = 'Your administrator needs to register this site with at least one hub before you can publish a competition. Contact your site administrator.';
...
$string['publicationinfo'] = 'Competition publication information';
...
$string['publisheremail_help'] = 'The publisher email address allows the hub administrator to alert the publisher about any changes to the status of the published competition.';
$string['publishername'] = 'Publisher';
$string['publishername_help'] = 'The publisher is the person or organisation that is the official publisher of the competition.  Unless you are publishing it on behalf of someone else, it will usually be you.';
...
$string['registeredcourses'] = 'Registered competitions';
...
$string['registrationconfirmedon'] = 'You are now registered on the hub {$a}. You are now able to publish competitions to this hub, using the "Publish" link in competition administration menus.';
...
$string['screenshots_help'] = 'Any screenshots of the competition will be displayed in search results.';
$string['search'] = 'Search';
$string['selecthub'] = 'Select hub';
$string['selecthubinfo'] = 'A community hub is a server that lists competitions. You can only publish your competitions on hubs that this Moodle site is registered with.  If the hub you want is not listed below, please contact your site administrator.';
$string['selecthubforadvertise'] = 'Select hub for advertising';
$string['selecthubforsharing'] = 'Select hub for uploading';
$string['sendingcourse'] = 'Sending competition';
$string['sendingsize'] = 'Please wait the competition file is uploading ({$a->total}Mb)...';
...
$string['share'] = 'Share this competition for people to download';
$string['shared'] = 'Shared';
$string['shareon'] = 'Upload this competition to {$a}';
$string['shareonhub'] = 'Upload this competition to a hub';
$string['shareonmoodleorg'] = 'Upload this competition to MOOCH';
$string['sharepublication_help'] = 'Uploading this competition to a community hub server will enable people to download it and install it on their own Moodle sites.';
...
$string['subject_help'] = 'Select the main subject area which the competition covers.';
...
$string['tags'] = 'Tags';
$string['tags_help'] = 'Tags help to further categorise your competition and help it to be found. Please use simple, meaningful words and separate them with a comma. Example: math, algebra, geometry';
...
$string['unpublishalladvertisedcourses'] = 'Remove all competitions currently being advertised on a hub';
$string['unpublishalluploadedcourses'] = 'Removed all competitions that were uploaded to a hub';
$string['unpublishconfirmation'] = 'Do you really want to remove the competition "{$a->courseshortname}" from the hub "{$a->hubname}"';
$string['unpublishcourse'] = 'Unpublish {$a}';
$string['unregister'] = 'Unregister';
$string['unregisterfrom'] = 'Unregister from {$a}';
$string['unregisterconfirmation'] = 'You are about to unregister this site from the hub {$a}.  Once you disconnect from it, you will not be able to manage any competitions you left there.  Are you sure you want to unregister?';
...
$string['xmlrpcdisabledcommunity'] = 'The XML-RPC extension is not enabled on the server. You can not search and download competitions.';
$string['xmlrpcdisabledpublish'] = 'The XML-RPC extension is not enabled on the server. You can not publish competitions or manage published competitions.';
