...
$string['courseevent'] = 'Competition event';
$string['courseevents'] = 'Competition events';
...
$string['errorbeforecoursestart'] = 'Cannot set event before competition start date';
...
$string['eventsrelatedtocourses'] = 'Events related to competitions';
...
$string['tt_hidecourse'] = 'Competition events are shown (click to hide)';
...
$string['tt_showcourse'] = 'Competition events are hidden (click to show)';
...
$string['typecourse'] = 'Competition event';
