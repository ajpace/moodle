...
$string['aggregationposition_help'] = 'This setting determines whether the category and competition total columns are displayed first or last in the gradebook reports.';
...
$string['courseavg'] = 'Competition average';
$string['coursegradecategory'] = 'Competition grade category';
$string['coursegradedisplaytype'] = 'Competition grade display type';
$string['coursegradedisplayupdated'] = 'The competition grade display type has been updated.';
$string['coursegradesettings'] = 'Competition grade settings';
$string['coursename'] = 'Competition name';
$string['coursescales'] = 'Competition scales';
$string['coursesettings'] = 'Competition settings';
$string['coursesettingsexplanation'] = 'Competition settings determine how the gradebook appears for all participants in the competition.';
$string['coursetotal'] = 'Competition total';
...
$string['errornocourse'] = 'Could not get competition information';
...
$string['gradeoutcomescourses'] = 'Competition outcomes';
$string['gradepass'] = 'Grade to pass';
$string['gradepass_help'] = 'This setting determines the minimum grade required to pass. The value is used in activity and competition completion, and in the gradebook, where pass grades are highlighted in green and fail grades in red.';
...
$string['importcustom'] = 'Import as custom outcomes (only this competition)';
...
$string['includescalesinaggregation_help'] = 'You can change whether scales are to be included as numbers in all aggregated grades across all gradebooks in all competitions. CAUTION: changing this setting will force all aggregated grades to be recalculated.';
$string['incorrectcourseid'] = 'Competition ID was incorrect';
...
$string['no'] = 'No';
$string['nocategories'] = 'Grade categories could not be added or found for this competition';
$string['nocategoryname'] = 'No category name was given.';
$string['nocategoryview'] = 'No category to view by';
$string['nocourses'] = 'There are no competitions yet';
...
$string['nooutcomes'] = 'Outcome items must be linked to a competition outcome, but there are no outcomes for this competition. Would you like to add one?';
...
$string['noscales'] = 'Outcomes must be linked to a competition scale or global scale, but there are none. Would you like to add one?';
...
$string['outcomeassigntocourse'] = 'Assign another outcome to this competition';
...
$string['outcomescourse'] = 'Outcomes used in competition';
...
$string['outcomestandard_help'] = 'A standard outcome is available site-wide, for all competitions.';
...
$string['overridesitedefaultgradedisplaytype_help'] = 'If ticked, grade letters and boundaries for the competition may be set, rather than using the site defaults.';
...
$string['recovergradesdefault_help'] = 'By default recover old grades when re-enrolling a user in a competition.';
...
$string['seeallcoursegrades'] = 'See all competition grades';
...
$string['setcategorieserror'] = 'You must first set the categories for your competition before you can give weights to them.';
...
$string['unenrolledusersinimport'] = 'This import included the following grades for users not currently enrolled in this competition: {$a}';
...
$string['usedcourses'] = 'Used competitions';
...
$string['weightcourse'] = 'Use weighted grades for competition';
