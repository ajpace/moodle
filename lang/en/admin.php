...
$string['allowcoursethemes'] = 'Allow competition themes';
...
$string['backup_shortname'] = 'Use competition name in backup filename';
$string['backup_shortnamehelp'] = 'Use the competition name as part of the backup filename.';
...
$string['configallowcategorythemes'] = 'If you enable this, then themes can be set at the category level. This will affect all child categories and competitions unless they have specifically set their own theme. WARNING: Enabling category themes may affect performance.';
$string['configallowcoursethemes'] = 'If you enable this, then competitions will be allowed to set their own themes.  Competition themes override all other theme choices (site, user, or session themes)';
...
$string['configallowuserthemes'] = 'If you enable this, then users will be allowed to set their own themes.  User themes override site themes (but not competition themes)';
$string['configallusersaresitestudents'] = 'For activities on the front page of the site, should ALL users be considered as students?  If you answer "Yes", then any confirmed user account will be allowed to participate as a student in those activities.  If you answer "No", then only users who are already a participant in at least one competition will be able to take part in those front page activities. Only admins and specially assigned teachers can act as teachers for these front page activities.';
...
$string['configautologinguests'] = 'Should visitors be logged in as guests automatically when entering competitions with guest access?';
...
$string['configcourserequestnotify'] = 'Type username of user to be notified when new competition requested.';
$string['configcourserequestnotify2'] = 'Users who will be notified when a competition is requested. Only users who can approve competition requests are listed here.';
$string['configcoursesperpage'] = 'Enter the number of competitions to be display per page in a competition listing.';
...
$string['configdefaultrequestcategory'] = 'Competitions requested by users will be automatically placed in this category.';
$string['configdefaultrequestedcategory'] = 'Default category to put competitions that were requested into, if they\'re approved.';
$string['configdefaultuserroleid'] = 'All logged in users will be given the capabilities of the role you specify here, at the site level, in ADDITION to any other roles they may have been given.  The default is the Authenticated user role.  Note that this will not conflict with other roles they have unless you prohibit capabilities, it just ensures that all users have capabilities that are not assignable at the competition level (eg post blog entries, manage own calendar, etc).';
...
$string['configenablecourserequests'] = 'This will allow any user to request a competition be created.';
...
$string['configenablestats'] = 'If you choose \'yes\' here, Moodle\'s cronjob will process the logs and gather some statistics.  Depending on the amount of traffic on your site, this can take awhile. If you enable this, you will be able to see some interesting graphs and statistics about each of your competitions, or on a sitewide basis.';
...
$string['configforcelogin'] = 'Normally, the front page of the site and the competition listings (but not competitions) can be read by people without logging in to the site.  If you want to force people to log in before they do ANYTHING on the site, then you should enable this setting.';
...
$string['configgradebookroles'] = 'This setting allows you to control who appears on the gradebook.  Users need to have at least one of these roles in a competition to be shown in the gradebook for that competition.';
...
$string['confighiddenuserfields'] = 'Select which user information fields you wish to hide from other users other than competition teachers/admins. This will increase student privacy. Hold CTRL key to select multiple fields.';
...
$string['configmaxbytes'] = 'This specifies a maximum size that uploaded files can be throughout the whole site. This setting is limited by the PHP settings post_max_size and upload_max_filesize, as well as the Apache setting LimitRequestBody. In turn, maxbytes limits the range of sizes that can be chosen at competition level or module level. If \'Server Limit\' is chosen, the server maximum allowed by the server will be used.';
...
$string['configmycoursesperpage'] = 'Maximum number of competitions to display in any list of a user\'s own competitions';
...
$string['confignavcourselimit'] = 'Limits the number of competitions shown to the user when they are either not logged in or are not enrolled in any competitions.';
$string['confignavshowallcourses'] = 'If enabled users will see competitions they are enrolled in both within the My Competitions branch and the competition structure. When disabled users with enrolments will only see the My Competitions branch of the navigaiton. The number of competition shown would still be limited by "Course limit(navcourselimit)" setting when user is either not logged in or not enrolled in any competition.';
$string['confignavshowcategories'] = 'Show competition categories in the navigation bar and navigation blocks. This does not occur with competitions the user is currently enrolled in, they will still be listed under mycompetitions without categories.';
...
$string['configopentogoogle'] = 'If you enable this setting, then Google will be allowed to enter your site as a Guest.  In addition, people coming in to your site via a Google search will automatically be logged in as a Guest.  Note that this only provides transparent access to competitions that already allow guest access.';
...
$string['configprofilesforenrolledusersonly'] = 'To prevent misuse by spammers, profile descriptions of users who are not yet enrolled in any competition are hidden. New users must enrol in at least one competition before they can add a profile description.';
...
$string['configrequestedstudentname'] = 'Word for student used in requested competitions';
$string['configrequestedstudentsname'] = 'Word for students used in requested competitions';
$string['configrequestedteachername'] = 'Word for teacher used in requested competitions';
$string['configrequestedteachersname'] = 'Word for teachers used in requested competitions';
...
$string['configsectionrequestedcourse'] = 'Competition requests';
...
$string['configstatsuserthreshold'] = 'This setting specifies the minimum number of enrolled users for a competition to be included in statistics calculations.';
...
$string['configuseblogassociations'] = 'Should users be able to organize their blog by associating entries with competitions and competition modules?';
...
$string['configvisiblecourses'] = 'Display competitions in hidden categories normally';
...
$string['coursecontact'] = 'Competition contacts';
$string['coursecontact_desc'] = 'This setting allows you to control who appears on the competition description. Users need to have at least one of these roles in a competition to be shown on the competition description for that competition.';
$string['courselistshortnames'] = 'Display extended competition names';
$string['courselistshortnames_desc'] = 'When showing lists of competitions, or when referring to competitions on administration screens, show the competition short name as well as the full name. In fact, when you turn this setting on, the display uses the \'courseextendednamedisplay\' language string, so you can changewhat is displayed using Language customisation.';
$string['coursemgmt'] = 'Add/edit competitions';
$string['courseoverview'] = 'Competition overview';
$string['courserequestnotify'] = 'Competition request notification';
$string['courserequestnotifyemail'] = 'User {$a->user} requested a new competition at {$a->link}';
$string['courserequests'] = 'Competition requests';
$string['courserequestspending'] = 'Pending competition requests';
$string['courses'] = 'Competitions';
$string['coursesperpage'] = 'Competitions per page';
$string['creatornewroleid'] = 'Creators\' role in new competitions';
$string['creatornewroleid_help'] = 'If the user does not already have the permission to manage the new competition, the user is automatically enrolled using this role.';
$string['cron'] = 'Cron';
...
$string['defaultrequestcategory'] = 'Default category for competition requests';
...
$string['enablecourserequests'] = 'Enable competition requests';
...
$string['enrolinstancedefaults_desc'] = 'Default enrolment settings in new competitions.';
...
$string['guestroleid_help'] = 'This role is automatically assigned to the guest user. It is also temporarily assigned to not enrolled users that enter the competition via guest enrolment plugin.';
...
$string['legacyfilesinnewcourses'] = 'Legacy competition files in new competitions';
$string['legacyfilesinnewcourses_help'] = 'By default legacy competition files areas are available only in upgraded competitions. Please note some features like single activity backup/restore are not compatible with this settings.';
...
$string['mnetrestore_extusers_noadmin'] = '<strong>Note:</strong> This backup file seems to come from a different Moodle installation and contains remote Moodle Network user accounts. You are not allowed to execute this type of restore. Contact the administrator of the site or, alternatively, restore this competition without any user information (modules, files...)';
...
$string['mycoursesperpage'] = 'Number of competitions';
...
$string['navadduserpostslinks_help'] = 'If enabled two links will be added to each user in the navigation to view discussions the user has started and posts the user has made in forums throughout the site or in specific competitions.';
$string['navigationupgrade'] = 'This upgrade introduces two new navigation blocks that will replace these blocks: Administration, Competitions, Activities and Participants.  If you had set any special permissions on those blocks you should check to make sure everything is behaving as you want it.';
$string['navcourselimit'] = 'Competition limit';
...
$string['navshowallcourses'] = 'Show all competitions';
$string['navshowcategories'] = 'Show competition categories';
$string['navshowmycoursecategories'] = 'Show my competition categories';
$string['navshowmycoursecategories_help'] = 'If enabled competitions in the users my competitions branch will be shown in categories.';
...
$string['numcoursesincombo'] = 'Maximum number of competitions in combo list';
$string['numcoursesincombo_help'] = 'The combo list doesn\'t work well with large numbers of competitions. When the total number of competitions in the site is higher than this setting then a link to the dedicated competition listing will be shown instead of trying to display all the competitions on the front page.';
...
$string['registermoodleorgli3'] = 'Your site is also registered with the Moodle.org Open Community Hub ({$a}), allowing users with the publish competitions capability (by default only managers) the option of publishing competitions to MOOCH.';
$string['registerwithmoodleorg'] = 'Register with Moodle.org';
$string['registration'] = 'Registration';
$string['registration_help'] = 'It is recommended to register on Moodle.org to receive security email alerts, to contribute to the Moodle growth and statistics, or to be able to share competitions on MOOCH.';
...
$string['restorernewroleid'] = 'Restorers\' role in competitions';
$string['restorernewroleid_help'] = 'If the user does not already have the permission to manage the newly restored competition, the user is automatically assigned this role and enrolled if necessary. Select "None" if you do not want restorers to be able to manage every restored competition.';
...
$string['stickyblockscourseview'] = 'Competition page';
