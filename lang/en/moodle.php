...
$string['activities_help'] = 'Activities, such as forums, quizzes and wikis, enable interactive content to be added to the competition.';
...
$string['addcreator'] = 'Add competition creator';
$string['adddots'] = 'Add...';
...
$string['addedtogroupnotenrolled'] = 'Not added to group "{$a}", because not enrolled in competition';
...
$string['addnewcourse'] = 'Add a new competition';
...
$string['adminhelpassigncreators'] = 'Competition creators can create new competitions';
$string['adminhelpassignsiteroles'] = 'Apply defined site roles to specific users';
$string['adminhelpassignstudents'] = 'Go into a competition and add students from the admin menu';
...
$string['adminhelpcourses'] = 'Define competitions and categories and assign people to them, edit pending competitions';
...
$string['administratordescription'] = 'Administrators can usually do anything on the site, in all competitions.';
...
$string['areyousuretorestorethisinfo'] = 'Later in this process you will have a choice of adding this backup to an existing competition or creating a completely new competition.';
...
$string['availability_help'] = 'This setting determines whether the competition appears in the list of competitions. Apart from teachers and administrators, users are not allowed to enter the competition.';
$string['availablecourses'] = 'Available competitions';
$string['back'] = 'Back';
$string['backto'] = 'Back to {$a}';
$string['backtocourselisting'] = 'Back to competition listing';
...
$string['backupcoursefileshelp'] = 'If enabled then competition files will be included in automated backups';
...
$string['backupfailed'] = 'Some of your competitions weren\'t saved!!';
...
$string['backupincludemoduleshelp'] = 'Choose whether you want to include competition modules, with or without user data, in automated backups';
$string['backupincludemoduleuserdatahelp'] = 'Choose whether you want to include module user data in automated backups.';
$string['backupkeephelp'] = 'How many recent backups for each competition do you want to keep? (older ones will be deleted automatically)';
...
$string['backupsavetohelp'] = 'Full path to the directory where you want to save the backup files<br />(leave blank to save in its competition default dir)';
$string['backupsitefileshelp'] = 'If enabled then site files used in competitions will be included in automated backups';
...
$string['brief'] = 'Brief';
$string['bycourseorder'] = 'By competition order';
$string['byname'] = 'by {$a}';
$string['bypassed'] = 'Bypassed';
$string['cachecontrols'] = 'Cache controls';
$string['cancel'] = 'Cancel';
$string['cancelled'] = 'Cancelled';
$string['categories'] = 'Competition categories';
$string['category'] = 'Category';
$string['category_help'] = 'This setting determines the category in which the competition will appear in the list of competitions.';
$string['categoryadded'] = 'The category \'{$a}\' was added';
$string['categorycontents'] = 'Subcategories and competitions';
...
$string['idnumbercoursecategory_help'] = 'The ID number of a competition category  is only used when matching the category against external systems and is not displayed anywhere on the site. If the category has an official code name it may be entered, otherwise the field can be left blank.';
...
$string['continuetocourse'] = 'Click here to enter your competition';
...
$string['copyingcoursefiles'] = 'Copying competition files';
$string['copyingsitefiles'] = 'Copying site files used in competition';
...
$string['courseadministration'] = 'Competition administration';
$string['courseapprovedemail'] = 'Your requested competition, {$a->name}, has been approved and you have been made a {$a->teacher}.  To access your new competition, go to {$a->url}';
$string['courseapprovedemail2'] = 'Your requested competition, {$a->name}, has been approved.  To access your new competition, go to {$a->url}';
$string['courseapprovedfailed'] = 'Failed to save the competition as approved!';
$string['courseapprovedsubject'] = 'Your competition has been approved!';
$string['courseavailable'] = 'This competition is available to students';
$string['courseavailablenot'] = 'This competition is not available to students';
$string['coursebackup'] = 'Competition backup';
$string['coursecategories'] = 'Competition categories';
$string['coursecategory'] = 'Competition category';
$string['coursecategorydeleted'] = 'Deleted competition category {$a}';
$string['coursecompletion'] = 'Competition completion';
$string['coursecompletions'] = 'Competition completions';
$string['coursecreators'] = 'Competition creator';
$string['coursecreatorsdescription'] = 'Competition creators can create new competitions.';
$string['coursedisplay'] = 'Competition layout';
$string['coursedisplay_help'] = 'This setting determines whether the whole competition is displayed on one page or split over several pages. The setting has no affect on certain competition formats, such as SCORM format.';
$string['coursedisplay_single'] = 'Show all sections on one page';
$string['coursedisplay_multi'] = 'Show one section per page';
$string['coursedeleted'] = 'Deleted competition {$a}';
$string['courseextendednamedisplay'] = '{$a->shortname} {$a->fullname}';
$string['coursefiles'] = 'Legacy competition files';
$string['coursefilesedit'] = 'Edit legacy competition files';
$string['coursefileswarning'] = 'Competition files are deprecated';
$string['coursefileswarning_help'] = 'Competition files are deprecated since Moodle 2.0, please use external repositories instead as much as possible.';
$string['courseformatdata'] = 'Competition format data';
$string['courseformats'] = 'Competition formats';
$string['coursegrades'] = 'Competition grades';
$string['coursehelpcategory'] = 'Position the competition on the competition listing and may make it easier for students to find it.';
$string['coursehelpforce'] = 'Force the competition group mode to every activity in the competition.';
$string['coursehelpformat'] = 'The competition main page will be displayed in this format.';
$string['coursehelphiddensections'] = 'How the hidden sections in the competition are displayed to students.';
$string['coursehelpmaximumupload'] = 'Define the largest size of file that can be uploaded in this competition, limited by the site-wide setting.';
$string['coursehelpnewsitemsnumber'] = 'Number of recent items appearing on the competition home page, in a news box down the right-hand side (0 means the news box won\'t appear).';
$string['coursehelpnumberweeks'] = 'Number of weeks/topics displayed on the competition main page.';
$string['coursehelpshowgrades'] = 'Enable the display of the gradebook. It does not prevent grades from being displayed within the individual activities.';
$string['coursehidden'] = 'This competition is currently unavailable to students';
$string['courseinfo'] = 'Competition info';
$string['coursemessage'] = 'Message competition users';
$string['coursenotaccessible'] = 'This competition does not allow public access';
$string['courselegacyfiles'] = 'Legacy competition files';
$string['courselegacyfiles_help'] = 'The competition files area provides some backward compatibility with Moodle 1.9 and earlier.  All files in this area are always accessible to all participants in the competition (whether you link to them or not) and there is no way to know where any of these files are being used in Moodle.

If you use this area to store competition files, you can expose yourself to a number of privacy and security issues, as well as experiencing missing files in backups, competition imports and any time content is shared or re-used.  It is therefore recommended that you do not use this area unless you really know what you are doing.
...
$string['courseoverview'] = 'Competition overview';
$string['courseoverviewgraph'] = 'Competition overview graph';
$string['courseprofiles'] = 'Competition profiles';
...
$string['coursereject'] = 'Reject a competition request';
$string['courserejected'] = 'Competition has been rejected and the requester has been notified.';
$string['courserejectemail'] = 'Sorry, but the competition you requested has been rejected. Here is the reason provided:

{$a}';
$string['courserejectreason'] = 'Outline your reasons for rejecting this competition<br />(this will be emailed to the requester)';
$string['courserejectsubject'] = 'Your competition has been rejected';
$string['coursereport'] = 'Competition report';
$string['coursereports'] = 'Competition reports';
$string['courserequest'] = 'Competition request';
$string['courserequestdetails'] = 'Details of the competition you are requesting';
$string['courserequestfailed'] = 'For some reason, your competition request could not be saved';
$string['courserequestintro'] = 'Use this form to request a competition to be created for you.<br />Try and fill in as much information as you can to allow<br />the administrators to understand your reasons for wanting this competition.';
$string['courserequestreason'] = 'Reasons for wanting this competition';
$string['courserequestsuccess'] = 'Successfully saved your competition request. Expect an email within a few days with the outcome';
$string['courserequestsupport'] = 'Supporting information to help the administrator evaluate this request';
$string['courserestore'] = 'Competition restore';
$string['courses'] = 'Competitions';
$string['coursesectionsummaries'] = 'Competition section summaries';
$string['coursesettings'] = 'Competition default settings';
$string['coursesmovedout'] = 'Competitions moved out from {$a}';
$string['coursespending'] = 'Competitions pending approval';
$string['coursestart'] = 'Competition start';
$string['coursesummary'] = 'Competition summary';
$string['coursesummary_help'] = 'The competition summary is displayed in the list of competitions. A competition search searches competition summary text in addition to competition names.';
$string['courseupdates'] = 'Competition updates';
$string['courseuploadlimit'] = 'Competition upload limit';
...
$string['creatingcoursemodules'] = 'Creating competition modules';
$string['creatingcourseroles'] = 'Creating competition level role assignments and overrides';
...
$string['creatingnewcourse'] = 'Creating new competition';
...
$string['currentcourseadding'] = 'Current competition, adding data to it';
$string['currentcoursedeleting'] = 'Current competition, deleting it first';
...
$string['defaultcoursestudentdescription'] = 'Students generally have fewer privileges within a competition.';
$string['defaultcoursestudents'] = 'Students';
$string['defaultcoursesummary'] = 'Write a concise and interesting paragraph here that explains what this competition is about';
$string['defaultcourseteacher'] = 'Teacher';
$string['defaultcourseteacherdescription'] = 'Teachers can do anything within a competition, including changing the activities and grading students.';
...
$string['deletecategorycheck'] = 'Are you absolutely sure you want to completely delete this category <b>\'{$a}\'</b>?<br />This will move all competitions into the parent category if there is one, or into Miscellaneous.';
$string['deletecategorycheck2'] = 'If you delete this category, you need to choose what to do with the competitions and subcategories it contains.';
$string['deletecomment'] = 'Delete this comment';
$string['deletecompletely'] = 'Delete completely';
$string['deletecourse'] = 'Delete a competition';
$string['deletecoursecheck'] = 'Are you absolutely sure you want to completely delete this competition and all the data it contains?';
...
$string['deletingexistingcoursedata'] = 'Deleting existing competition data';
...
$string['dndworkingfiletextlink'] = 'Drag and drop files, text or links onto competition sections to upload them';
$string['dndworkingfilelink'] = 'Drag and drop files or links onto competition sections to upload them';
$string['dndworkingfiletext'] = 'Drag and drop files or text onto competition sections to upload them';
$string['dndworkingfile'] = 'Drag and drop files onto competition sections to upload them';
$string['dndworkingtextlink'] = 'Drag and drop text or links onto competition sections to upload them';
$string['dndworkingtext'] = 'Drag and drop text onto competition sections to upload it';
$string['dndworkinglink'] = 'Drag and drop links onto competition sections to upload them';
...
$string['duplicatecontcourse'] = 'Return to the competition';
...
$string['editcoursesettings'] = 'Edit competition settings';
...
$string['emaildisplaycourse'] = 'Allow only other competition members to see my email address';
...
$string['entercourse'] = 'Click to enter this competition';
...
$string['existingcourse'] = 'Existing competition';
$string['existingcourseadding'] = 'Existing competition, adding data to it';
$string['existingcoursedeleting'] = 'Existing competition, deleting it first';
$string['existingcreators'] = 'Existing competition creators';
...
$string['expirynotifyemail'] = 'The following students in this competition are expiring after exactly {$a->threshold} days:

{$a->current}

The following students in this competition are expiring in less than {$a->threshold} days:
...
$string['expirynotifystudents_help'] = 'If an enrolment duration has been specified, then this setting determines whether students receive email notification when they are about to be unenrolled from the competition.';
$string['expirynotifystudentsemail'] = 'Dear {$a->studentstr}:

This is a notification that your enrolment in the competition {$a->course} will expire in {$a->threshold} days.

Please contact {$a->teacherstr} for any further enquiries.';
$string['expirythreshold'] = 'Threshold';
$string['expirythreshold_help'] = 'If an enrolment duration has been specified, then this setting determines the number of days notice given before students are unenrolled from the competition.';
...
$string['findmorecourses'] = 'Find more competitions...';
...
$string['format_help'] = 'The competition format determines the layout of the competition page.

* SCORM format - For displaying a SCORM package in the first section of the competition page (as an alternative to using the SCORM/AICC module)
* Social format - A forum is displayed on the competition page
* Topics format - The competition page is organised into topic sections
* Weekly format - The competition page is organised into weekly sections, with the first week starting on the competition start date';
...
$string['frontpagecourselist'] = 'List of competitions';
...
$string['fulllistofcourses'] = 'All competitions';
$string['fullname'] = 'Full name'; // @deprecated - use fullnamecourse or fullnameuser or some own context specific string
$string['fullnamecourse'] = 'Competition full name';
$string['fullnamecourse_help'] = 'The full name of the competition is displayed at the top of each page in the competition and in the list of competitions.';
...
$string['guestuserinfo'] = 'This user is a special user that allows read-only access to some competitions.';
$string['help'] = 'Help';
...
$string['hiddensections_help'] = 'This setting determines whether hidden sections are displayed to students in collapsed form (perhaps for a competition in weekly format to indicate holidays) or are completely hidden.';
...
$string['checkingcourse'] = 'Checking competition';
...
$string['childcoursenotfound'] = 'Child competition not found!';
$string['childcourses'] = 'Child competitions';
$string['choose'] = 'Choose';
$string['choosecourse'] = 'Choose a competition';
...
$string['idnumbercourse'] = 'Competition ID number';
$string['idnumbercourse_help'] = 'The ID number of a competition is only used when matching the competition against external systems and is not displayed anywhere on the site. If the competition has an official code name it may be entered, otherwise the field can be left blank.';
...
$string['importdata'] = 'Import competition data';
$string['importdataexported'] = 'Exported data from \'from\' competition successfully.<br /> Continue to import into your \'to\' competition.';
$string['importdatafinished'] = 'Import complete! Continue to your competition';
$string['importdatafrom'] = 'Find a competition to import data from:';
$string['inactive'] = 'Inactive';
$string['include'] = 'Include';
$string['includeallusers'] = 'Include all users';
$string['includecoursefiles'] = 'Include competition files';
$string['includecourseusers'] = 'Include competition users';
...
$string['includesitefiles'] = 'Include site files used in this competition';
...
$string['listofcourses'] = 'List of competitions';
$string['local'] = 'Local';
...
$string['loginsteps'] = 'Hi! For full access to competitions you\'ll need to take
   a minute to create a new account for yourself on this web site.
   Each of the individual competitions may also have a one-time
   ...
   <li>Now, select the competition you want to participate in.</li>
   <li>If you are prompted for an "enrolment key" - use the one
   that your teacher has given you. This will "enrol" you in the
   competition.</li>
   <li>You can now access the full competition. From now on you will only need
   to enter your personal username and password (in the form on this page)
   to log in and access any competition you have enrolled in.</li>
   </ol>';
$string['loginstepsnone'] = '<p>Hi!</p>
<p>For full access to competitions you\'ll need to create yourself an account.</p>
...
$string['managecourses'] = 'Manage competitions';
...
$string['maximumupload_help'] = 'This setting determines the largest size of file that can be uploaded to the competition, limited by the site-wide setting set by an administrator. Activity modules also include a maximum upload size setting for further restricting the file size.';
$string['maxnumberweeks'] = 'Maximum for number of weeks/topics';
$string['maxnumberweeks_desc'] = 'This controls the maximum options that appears in the "Number of weeks/topics" setting for competitions.';
$string['maxsize'] = 'Max size: {$a}';
$string['maxfilesize'] = 'Maximum size for new files: {$a}';
$string['maxnumcoursesincombo'] = 'Browse <a href="{$a->link}">{$a->numberofcourses} competitions</a>.';
$string['memberincourse'] = 'People in the competition';
...
$string['messageprovider:courserequestapproved'] = 'Competition creation request approval notification';
$string['messageprovider:courserequested'] = 'Competition creation request notification';
$string['messageprovider:courserequestrejected'] = 'Competition creation request rejection notification';
...
$string['movecourseto'] = 'Move competition to:';
...
$string['moveselectedcoursesto'] = 'Move selected competitions to...';
...
$string['mycourses'] = 'My competitions';
...
$string['newcourse'] = 'New competition';
...
$string['newsitemsnumber_help'] = 'This setting determines how many recent items appear in the latest news block on the competition page. If set to "0 news items" then the latest news block will not be displayed.';
...
$string['nocourses'] = 'No competitions';
$string['nocoursesfound'] = 'No competitions were found with the words \'{$a}\'';
$string['nocoursesyet'] = 'No competitions in this category';
...
$string['nofilesyet'] = 'No files have been uploaded to your competition yet';
$string['nograde'] = 'No grade';
$string['nohelpforactivityorresource'] = 'There is currently no help associated with this resource or activity';
$string['nochange'] = 'No change';
$string['noimagesyet'] = 'No images have been uploaded to your competition yet';
$string['nologsfound'] = 'No logs have been found';
$string['nomatchingusers'] = 'No users match \'{$a}\'';
$string['nomorecourses'] = 'No more matching competitions could be found';
$string['nomoreidnumber'] = 'Not using an idnumber to avoid collisions';
$string['none'] = 'None';
$string['noneditingteacher'] = 'Non-editing teacher';
$string['noneditingteacherdescription'] = 'Non-editing teachers can teach in competitions and grade students, but may not alter activities.';
$string['nonstandard'] = 'Non-standard';
$string['nopendingcourses'] = 'There are no competitions pending approval';
$string['nopotentialadmins'] = 'No potential admins';
$string['nopotentialcreators'] = 'No potential competition creators';
...
$string['nosite'] = 'Could not find site-level competition';
$string['nostudentsfound'] = 'No {$a} found';
$string['nostudentsingroup'] = 'There are no students in this group yet';
$string['nostudentsyet'] = 'No students enrolled in this competition yet';
$string['nosuchemail'] = 'No such email address';
$string['notavailable'] = 'Not available';
$string['noteachersyet'] = 'No teachers in this competition yet';
$string['notenrolled'] = '{$a} is not enrolled in this competition.';
$string['notenrolledprofile'] = 'This profile is not available because this user is not enrolled in this competition.';
...
$string['noteuserschangednonetocourse'] = '<strong>Note:</strong> Competition users need to be restored when restoring user data (in activities, files or messages). This setting has been changed for you.';
...
$string['novalidcourses'] = 'No valid competitions to be shown';
$string['now'] = 'now';
$string['numattempts'] = '{$a} failed login attempt(s)';
$string['numberofcourses'] = 'Number of competitions';
...
$string['parentcoursenotfound'] = 'Parent competition not found!';
...
$string['paymentrequired'] = 'This competition requires a payment for entry.';
$string['payments'] = 'Payments';
$string['paymentsorry'] = 'Thank you for your payment!  Unfortunately your payment has not yet been fully processed, and you are not yet registered to enter the competition "{$a->fullname}".  Please try continuing to the competition in a few seconds, but if you continue to have trouble then please alert the {$a->teacher} or the site administrator';
$string['paymentthanks'] = 'Thank you for your payment!  You are now enrolled in your competition:<br />"{$a}"';
...
$string['potentialcreators'] = 'Potential competition creators';
...
$string['profilenotshown'] = 'This profile description will not be shown until this person is enrolled in at least one competition.';
...
$string['removecreator'] = 'Remove competition creator';
...
$string['requestcourse'] = 'Request a competition';
$string['requestedby'] = 'Requested by';
$string['requestedcourses'] = 'Requested competitions';
$string['requestreason'] = 'Reason for competition request';
$string['required'] = 'Required';
$string['requirespayment'] = 'This competition requires payment for access';
$string['reset'] = 'Reset';
$string['resetcomponent'] = 'Component';
$string['resetcourse'] = 'Reset competition';
$string['resetinfo'] = 'This page allows you to empty a competition of user data, while retaining the activities and other settings.  Please be warned that by choosing items below and submitting this page you will delete your chosen user data from this competition forever!';
...
$string['resortcoursesbyname'] = 'Re-sort competitions by name';
...
$string['resources_help'] = 'Resource types enable almost any kind of web content to be inserted into the competition.';
...
$string['restorecoursenow'] = 'Restore this competition now!';
...
$string['returntomaincoursepage'] = 'Return to main competition page';
$string['returntooriginaluser'] = 'Return to {$a}';
$string['revert'] = 'Revert';
$string['role'] = 'Role';
$string['rolemappings'] = 'Role mappings';
$string['rolerenaming'] = 'Role renaming';
$string['rolerenaming_help'] = 'This setting allows the displayed names for roles used in the competition to be changed. Only the displayed name is changed - role permissions are not affected.  New role names will appear on the competition participants page and elsewhere within the competition. If the renamed role is one that the administrator has selected as a competition manager role, then the new role name will also appear as part of the competition listings.';
$string['roles'] = 'Roles';
$string['rss'] = 'RSS';
...
$string['savechangesandreturntocourse'] = 'Save and return to competition';
...
$string['scalestandard_help'] = 'A standard scale is available site-wide, for all competitions.';
$string['scalestandard_link'] = 'grade/scale';
$string['scalestip'] = 'To create custom scales, use the \'Scales...\' link in your competition administration menu.';
$string['scalestip2'] = 'To create custom scales, click the Grades link in the competition administration menu, then choose Edit, Scales.';
...
$string['searchcourses'] = 'Search competitions';
...
$string['selectacourse'] = 'Select a competition';
$string['selectacoursesite'] = 'Select a competition or site';
...
$string['shortnamecollisionwarning'] = '[*] = This shortname is already in use by a competition and will need to be changed upon approval';
$string['shortnamecourse'] = 'Competition short name';
$string['shortnamecourse_help'] = 'The short name of the competition is displayed in the navigation and is used in the subject line of competition email messages.';
$string['shortnametaken'] = 'Short name is already used for another competition ({$a})';
...
$string['showallcourses'] = 'Show all competitions';
$string['showallusers'] = 'Show all users';
$string['showblockcourse'] = 'Show list of competitions containing block';
$string['showcomments'] = 'Show/hide comments';
$string['showcommentsnonjs'] = 'Show comments';
$string['showdescription'] = 'Display description on competition page';
$string['showdescription_help'] = 'If enabled, the introduction / description above will be displayed on the competition page just below the link to the activity / resource.';
$string['showgrades'] = 'Show gradebook to students';
$string['showgrades_help'] = 'Many activities in the competition allow grades to be set. This setting determines whether a student can view a list of all their grades for the competition via a grades link in the competition administration block.';
$string['showlistofcourses'] = 'Show list of competitions';
$string['showmodulecourse'] = 'Show list of competitions containing activity';
...
$string['sitefilesused'] = 'Site files used in this competition';
...
$string['someallowguest'] = 'Some competitions may allow guest access';
...
$string['starpending'] = '([*] = competition pending approval)';
$string['startdate'] = 'Competition start date';
$string['startdate_help'] = 'This setting determines the start of the first week for a competition in weekly format. It also determines the earliest date that logs of competition activities are available for.';
...
$string['statsnodata'] = 'There is no available data for that combination of competition and time period.';
$string['statsnodatauser'] = 'There is no available data for that combination of competition, user and time period.';
...
$string['statsreport11'] = 'Most active competitions';
$string['statsreport12'] = 'Most active competitions (weighted)';
$string['statsreport13'] = 'Most participatory competitions (enrolments)';
$string['statsreport14'] = 'Most participatory competitions (views/posts)';
...
$string['statsreport9'] = 'Logins (site competition)';
...
$string['studentnotallowed'] = 'Sorry, but you can not enter this competition as \'{$a}\'';
...
$string['summary_help'] = 'The idea of a summary is a short text to prepare students for the activities within the topic or week. The text is shown on the competition page under the section name.';
...
$string['thereareno'] = 'There are no {$a} in this competition';
$string['therearecourses'] = 'There are {$a} competitions';
...
$string['updatethiscourse'] = 'Update this competition';
...
$string['usingexistingcourse'] = 'Using existing competition';
$string['valuealreadyused'] = 'This value has already been used.';
$string['version'] = 'Version';
$string['view'] = 'View';
$string['viewallcourses'] = 'View all competitions';
$string['viewallcoursescategories'] = 'View all competitions and categories';
$string['viewfileinpopup'] = 'View file in a popup window';
$string['viewprofile'] = 'View profile';
$string['views'] = 'Views';
$string['viewsolution'] = 'view solution';
$string['virusfound'] = 'Attention administrator! Clam AV has found a virus in a file uploaded by {$a->user} for the competition {$a->course}. Here is the output of clamscan:';
$string['virusfoundlater'] = 'A file you uploaded on {$a->date} with the filename {$a->filename} for the competition {$a->course} has since been found to contain a virus.  Here is a summary of what has happened to your file:

{$a->action}

If this was submitted work, you may want to resubmit it so that your tutor can see it.';
$string['virusfoundlateradmin'] = 'Attention administrator! A file that was uploaded on {$a->date} with the filename {$a->filename} for the competition {$a->course} by the user {$a->user} has since been found to contain a virus.  Here is a summary of what has happened to the file:
...
$string['writingcoursedata'] = 'Writing competition data';
...
$string['youneedtoenrol'] = 'To perform that action you need to enrol in this competition.';
